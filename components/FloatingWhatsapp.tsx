...
function FloatingWhatsapp() {
  return (
    <Link
      ...
      target="_blank"
      className="reveal fixed group bottom-5 right-5 lg:right-8 lg:bottom-10 z-50 w-16 h-16 bg-primary-dark rounded-full  flex items-center justify-center hover:scale-110  hover:bg-[#25D366] transition-all  shadow shadow-primary-dark hover:shadow-[#25D366] border-2 border-[#fff] "
    >
